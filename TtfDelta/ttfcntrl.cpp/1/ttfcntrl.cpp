...
uint8 CMAP_FORMAT12_CONTROL[CMAP_FORMAT12_CONTROL_COUNT+1] =
   {
   CMAP_FORMAT12_CONTROL_COUNT, 
   TTFACC_WORD, /*  format */
   TTFACC_WORD, /*  revision */ 
   TTFACC_LONG, /*  length */ 
   TTFACC_LONG, /*  language */
   TTFACC_LONG, /*  nGroups */ 
   }; /*  CMAP_FORMAT12 */

#define FORMAT12_GROUPS_CONTROL_COUNT 3
uint8 FORMAT12_GROUPS_CONTROL[FORMAT12_GROUPS_CONTROL_COUNT+1] = 
   {
   FORMAT12_GROUPS_CONTROL_COUNT, 
   TTFACC_LONG, /*  startCharCode */ 
   TTFACC_LONG, /*  endCharCode */
   TTFACC_LONG, /*  startGlyphCode */ 
   }; /*  FORMAT12_GROUPS */
