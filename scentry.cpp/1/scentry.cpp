/********************************************************************** 
      ...
      10/14/97  [....]    accessing unitialized memory 
        ...
        int16 sBitmapEmboldeningVertExtra ) 
{
    ...
    { 
        ...
        { 
            pbmpBitMap->rectBounds.right = (int16)(pbmpBitMap->rectBounds.right + sBitmapEmboldeningHorExtra);
        } 
        else
        {
            pbmpBitMap->rectBounds.left = (int16)(pbmpBitMap->rectBounds.left + sBitmapEmboldeningHorExtra);
        } 
        if (sBitmapEmboldeningVertExtra > 0)
        { 
            pbmpBitMap->rectBounds.bottom = (int16)(pbmpBitMap->rectBounds.bottom - sBitmapEmboldeningVertExtra); 
        }
        else 
        {
            pbmpBitMap->rectBounds.top = (int16)(pbmpBitMap->rectBounds.top - sBitmapEmboldeningVertExtra);
        }
    } 
...
{ 
    ...
    StateVars  *pState = &inputPtr->state;                  /* reentrant State is accessed via pointer */ 
...
) 
{
    ...
    srcRowPtr = (unsigned char *)pOverGBMap->pchBitMap;
    dstRowPtr = (unsigned char *)pGrayGBMap->pchBitMap;
        ...
        { 
            ...
            { 
                ...
                while(srcBitOffset < 0)
                {
                    ...
                    dstPtr[col] = (unsigned char)(dstPtr[col] + tableRow[index]); 
                    col++;
